...
class LLMAdapter:
    ...
    def _call_gemini(self, *, text: str) -> dict[str, Any]:
        ...
        prompt = (
            ...
            "Prioriza lecturas y observabilidad antes que mutaciones. "
            "Si el usuario pide recomendación prudente, mejora operativa o algo como 'sin tocar nada sensible', devuelve suggest_action, no una mutación. "
            "En suggest_action prioriza auditoría, capacidades, logs permitidos y explicación del estado. "
            "No sugieras de primeras restart/control u otras acciones sensibles salvo contexto muy explícito y directo. "
            "Si el usuario pide explicar qué significa un estado como enabled, disabled, expired o consumed, usa explain_status. "
            "Si llegas a proponer una mutación, que sea prudente, temporal y claramente una propuesta, no una recomendación fuerte. "
